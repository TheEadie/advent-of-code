...
public class Day22
{
    ...
    public async Task Part1()
    {
        ...
        _ = commands.RemoveAll(x => x.Cube.End.X > 50 || x.Cube.Start.X < -50
    ...
    private List<Command> ParseInput(string input) => input.Split("\n").Select(ParseCommand).ToList();
    ...
    private long GetVolume(Cube cube) => (cube.End.X + 1L - cube.Start.X) * (cube.End.Y + 1L - cube.Start.Y) * (cube.End.Z + 1L - cube.Start.Z);
